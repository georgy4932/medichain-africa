...
/* Icons */
const ic = (d, s = {}) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" style={{ width: 14, height: 14, ...s }}>
    {d}
  </svg>
)
...
const SearchIcon  = () => ic(<><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></>)
